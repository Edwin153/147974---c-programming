...
int main(){
  ...
  int age,period;// variable initialization
  float balance=50000;//balance declaration
  string status,name; 
  cout<<"enter your full name"<<endl;//get customer fullnames
  getline(cin,name);
cout<<"enter your age"<<endl;
cin>>age;

if (age>=22){
   cout<<"enter your bank balance"<<endl;//check customer balance
   cin>>balance;
   cout<<"enter your CRB status:"<<endl;//check CRB status
   cin>>status;
   cout<<"How long have you been our customer(in months):"<<endl;//check customer period
   cin>>period;
   if (balance>=50000 && status=="good" && period>=6){
